...
1. Using Google Colab (fastest performance) -
	...
	- Upload the datasets in the repository to the **/content/** of colab disk (note mentioned folder is default folder in colab disk, so no need to change anything)
